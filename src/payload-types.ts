...
export interface Page {
      ...
      | (
          | {
              ...
              skills: {
                value: string;
                /**
                 * Label for the skill, e.g., React, Node.js, etc. Should not exceed 36 characters.
                 */
                label: string;
                /**
                 * Hex color code for the skill ring, e.g., ff5733 without the #
                 */
                color?: string | null;
                id?: string | null;
              }[];
  ...
  themes: {
    theme: 'orange' | 'emerald' | 'violet' | 'red' | 'sky';
  };
  updatedAt: string;
  createdAt: string;
